...
<link href="${resource}/css/<spring:theme code="css"/>" rel="stylesheet">
<style>
body {
	padding-top: 60px;
...
<link href="${resource}/css/bootstrap-formhelpers-countries.flags.css" rel="stylesheet">
...
<link rel="shortcut icon" href="${resource}/ico/favicon.ico">
