...
public class HomeController {
	...
	public Collection<WrappedMessage> loadMoreMessages(
			@PathVariable String channel, @RequestParam int skip)
			throws InterruptedException {
		Thread.sleep(2000);
		Collection<Message> messagesByChannel = messageService
				.findMessagesByChannel(channelService.findByName(channel),
						MESSAGE_LIMIT, skip);
	...
	public String showRss(@PathVariable String channel, Model model,
	...
	private Collection<WrappedMessage> wrapMessages(
			Collection<Message> messagesByChannel) {
